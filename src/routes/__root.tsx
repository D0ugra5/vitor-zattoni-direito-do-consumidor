...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Landing page para captação de contatos via WhatsApp para advogado de Direito do Consumidor." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Landing page para captação de contatos via WhatsApp para advogado de Direito do Consumidor." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Landing page para captação de contatos via WhatsApp para advogado de Direito do Consumidor." },
