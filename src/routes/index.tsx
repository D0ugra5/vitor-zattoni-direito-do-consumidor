...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Vitor Zattoni Advogado | Direito do Consumidor" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Vitor Zattoni Advogado | Direito do Consumidor" },
      {
    ...
    <section className="border-t border-gold/15 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-5">
        <div className="grid items-center gap-12 md:grid-cols-2">
          {/* Photo placeholder — REPLACE the <img> src below with the professional photo */}
          <div className="reveal flex justify-center md:justify-start">
            <div className="relative aspect-[4/5] w-full max-w-sm overflow-hidden rounded-lg border border-gold/60 bg-navy">
              {/* TODO: Substituir o src abaixo pela foto profissional do Dr. Vitor Zattoni */}
              <img
                src=""
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="font-display text-7xl tracking-wider text-gold/80">VZ</span>
              </div>
          ...
          <div className="reveal">
            ...
            <p className="mt-5 text-offwhite/75">
              Atuação jurídica com clareza, responsabilidade e estratégia. O objetivo é
              oferecer orientação profissional para que o cliente compreenda seus direitos,
              avalie possibilidades e tome decisões com mais segurança.
            </p>

            <dl className="mt-8 space-y-2 text-sm text-offwhite/80">
              <Row label="OAB/UF" value="[inserir posteriormente]" />
              <Row label="Cidade/Estado" value="[inserir posteriormente]" />
              <Row label="Áreas" value="Direito do Consumidor · Direito Civil · Contratos" />
            </dl>

            <p className="mt-8 font-display text-lg italic text-gold">
              "Advocacia com postura ética, comunicação clara e atenção individualizada."
            </p>

            <div className="mt-8">
              <WhatsAppButton size="lg">Falar com Vitor Zattoni pelo WhatsApp</WhatsAppButton>
            </div>
          </div>
        </div>
      </div>
...
function Row({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col gap-0.5 border-b border-gold/15 py-2 sm:flex-row sm:gap-4">
      <dt className="text-gold/80">{label}</dt>
  ...
  return (
    <footer className="border-t border-gold/40 bg-navy-deep py-12">
      <div className="mx-auto max-w-6xl px-5">
        ...
        <p className="mt-10 text-center text-xs italic text-offwhite/55">
          As informações desta página possuem caráter exclusivamente informativo e não
